...
> **分类**：来源待确认 ｜ **文件数**：10 ｜ **仓库目录**：`interview-coach`

## 📌 简介

面试准备助手。用户提供简历和岗位JD后，支持两种模式：① 分析考点并生成针对性面试题目和参考答案；②
...
```bash
# 用户级（推荐）
cp -r . ~/.workbuddy/skills/interview-coach

# 或项目级
cp -r . <你的项目>/.workbuddy/skills/interview-coach
```
